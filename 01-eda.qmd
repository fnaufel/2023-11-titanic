...
1. Desfazer as transformações para fator, pois vão precisar fazer parte da receita.

1. Gravar df final como csv.

1. Preparar receita e modelo para prever `survived` (em outro .qmd).
